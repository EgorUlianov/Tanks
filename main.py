...
imgBrick = [
    ...
    pygame.image.load('image/bush.png')
]
# Танки
imgTanks = [
    [pygame.image.load('image/t1fr1.png'),
     pygame.image.load('image/t1fr2.png'),
     pygame.image.load('image/t1fr3.png'),
     pygame.image.load('image/t1fr4.png'),
     pygame.image.load('image/t1fr5.png'),
     pygame.image.load('image/t1fr6.png'),
     pygame.image.load('image/t1fr7.png')
     ],
    [pygame.image.load('image/t2fr1.png'),
     pygame.image.load('image/t2fr2.png'),
     pygame.image.load('image/t2fr3.png'),
     pygame.image.load('image/t2fr4.png'),
     pygame.image.load('image/t2fr5.png'),
     pygame.image.load('image/t2fr6.png'),
     pygame.image.load('image/t2fr7.png')
     ]
]
imgBangs = [
